...
namespace QLKS
{
    public partial class frmkhachhang : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if(add==true)
            {
                insertKH(txtMkh.Text, txtTenkh.Text, checkGioitinh(), dtpNgaysinh.Value.Month.ToString() +"/"+ dtpNgaysinh.Value.Day.ToString() + "/"+dtpNgaysinh.Value.Year.ToString(), txtCmnd.Text, txtDiachi.Text, txtSodt.Text, txtGhichu.Text);
            }
            else
            {
                updateKH(txtMkh.Text, txtTenkh.Text, checkGioitinh(), dtpNgaysinh.Value.Month.ToString() + "/" + dtpNgaysinh.Value.Day.ToString() + "/" + dtpNgaysinh.Value.Year.ToString(), txtCmnd.Text, txtDiachi.Text, txtSodt.Text, txtGhichu.Text);
            }
        }
