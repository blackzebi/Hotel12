...
namespace QLKS
{
    public partial class frmdatphong : Form
    {
        ...
        {
            insertInfoDatPhong(txtMpd.Text, cbxMakh.Text, datetimeden.Value.Month.ToString() + "/" + datetimeden.Value.Day.ToString() + "/" + datetimeden.Value.Year.ToString(), datetimedi.Value.Month.ToString() + "/" + datetimedi.Value.Day.ToString() + "/" + datetimedi.Value.Year.ToString(), Convert.ToInt32(txtTien.Text), txtManv.Text);
            loadListEmptyDatPhong();
            resetForm();
